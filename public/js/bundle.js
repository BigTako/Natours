      ...
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          return (0, _axios.default)({
            ...
            // if API and website are fosted in the same website
            data: {
              email: email,
              password: password
            },
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(name, email, password, passwordConfirm) {
    var pageProtocol, domain, port, url, res;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          pageProtocol = window.location.protocol; // Will be "http:" or "https:"
          domain = window.location.hostname; // Will be the domain name of the current page
          port = window.location.port;
          if (port) url = "".concat(pageProtocol, "//").concat(domain, ":").concat(port, "/api/v1/users/signup");else url = "".concat(pageProtocol, "//").concat(domain, "/api/v1/users/signup");
          _context.prev = 4;
          _context.next = 7;
          return (0, _axios.default)({
            method: 'POST',
        ...
        case 7:
          res = _context.sent;
          if (res.data.status === 'success') {
            (0, _alerts.showAlert)('success', 'Check an email and activate the account');
          }
          _context.next = 14;
          break;
        case 11:
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } /*eslint-disable */
var stripe = Stripe('pk_test_51NaaQrGeVdm4ggES6jj368eYjuQeg3PmSozymCRCqSHAMMzorDXTZ1WyZYh2AVE79PSYuDhJSvAGltinumz1jY2j00bcgqp17Y');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _axios.default)("/api/v1/bookings/checkout-session/".concat(tourId, "?date=").concat(dateId));
        case 3:
...
var tourDateSelect = document.getElementById('tour-date-select');
    ...
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            e.preventDefault();
            document.getElementById('passwordChangeBtn').textContent = 'Updating...';
          ...
          case 7:
            document.getElementById('passwordChangeBtn').textContent = 'Save password';
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  ...
  var selectedDate = tourDateSelect.value;
  console.log(selectedDate);
  var tourId = e.target.dataset.tourId;
  (0, _stripe.bookTour)(tourId, selectedDate);
});
